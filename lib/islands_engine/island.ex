defmodule IslandsEngine.Island do
  ...
  def new(type, %Coordinate{} = origin) do
    with [_|_] = offsets <- offsets(type), %MapSet{} = coordinates <- add_coordinates(offsets, origin) do
  ...
  defp add_coordinates(offsets, origin) do
    Enum.reduce_while(offsets, MapSet.new(), fn offset, acc ->
      add_coordinate(acc, origin, offset)
    end)
  end
